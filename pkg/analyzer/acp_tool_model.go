...
// IsCallbacksEnabled tells eino that this model handles callbacks internally,
// preventing the framework from wrapping it in callbackInjectedModel
// which would cause duplicate callback firings.
